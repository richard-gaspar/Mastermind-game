...
// console.log(activeRow);
// console.log(activeRow[1].style.backgroundColor);
...
const checkElement = function (index) {
  ...
  const valami = secretColorArray.findIndex(
    (element) => element === activeRow[index].style.backgroundColor
  );
  console.log(valami);
};
...
deleteBtn.addEventListener("click", function () {
  activeRow[activeRow.lastIndexOf()];
});
